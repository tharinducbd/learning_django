...
class Genre(models.Model):
    ...
    name = models.CharField(
        max_length=200,
        unique=True,
        help_text="Enter a book genre (e.g. Fantasy, French Poetry etc.)"
    )
...
class Book(models.Model):
    ...
    # Author as a string, not an object, because it hasn't been declared yet
...
class BookInstance(models.Model):
    ...
    class Meta:
        ...
        permissions = (
            ...
            ("can_renew", "Renew the book's loaned period"),
        )
